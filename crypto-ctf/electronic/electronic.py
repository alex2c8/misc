...
def oracle(plaintext):
    try:
        return CIPHER.encrypt(str(plaintext, encoding='utf-8') + FLAG)
    except Exception as e:
        return "Error: %s" % e

if __name__ == '__main__':
    while True:
        plaintext = base64.b64decode(input("Enter plaintext (base64): "))
        print("Ciphertext (hex) is: " + oracle(plaintext))
